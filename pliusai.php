        ...
        if(isset($_POST['submit'])){
            ...
            if(empty($sms_litai)){
	          ...
	          elseif($kainn > $apie['pliusai']){
	            ...
	            mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai +'$kiekis', pliusai=pliusai-'$kainn' WHERE nick='$nick' ");
			  }
        ...
        if(isset($_POST['submit'])){
            ...
            if(empty($litai)){
	          ...
	          elseif($kainn > $apie['pliusai']){
	            ...
	            mysqli_query($conn,"UPDATE zaidejai SET litai=litai +'$kiekis', pliusai=pliusai-'$kainn' WHERE nick='$nick' ");
			  }
        ...
        if(isset($_POST['submit'])){
            ...
            if(empty($kred)){
	          ...
	          elseif($kainn > $apie['pliusai']){
	            ...
	            mysqli_query($conn,"UPDATE zaidejai SET kred=kred +'$kiekis', pliusai=pliusai-'$kainn' WHERE nick='$nick' ");
			  }
