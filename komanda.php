...
<div class='meniuc'>";
            if ($info['foto'] == '') {
                ...
                $ft_ko = "<img src='$info[foto]'height='180' width='240'>";
            }
            echo '
...
Topic: <b>' . $info['topic'] . '</b></div>';
            ...
            if (apsas($user['team']) == apsas($ka)) {
                echo "<div class='up'>Komandos bosai</div>";
            }
            if (apsas($user['team']) == apsas($ka)) {
                echo "<div class='meniuc'> <a href='komanda.php?id=team_boss&ka=$ka'><font color='red'><h3><b>Komandos bosai</b></font></h3></a></div>
";
            }
...
' . $ico . ' Komandos kritinis lygis: <b>' . $info['kritinislvl'] . ' </b><img src="img/bicons/teams.png" /><br>';
            ...
            echo '';
            if (apsas($user['team']) == apsas($ka)) {
                echo '<div class="up">Narys/Vadas:</div>';
            }
            ...
            if (apsas($user['team']) == apsas($ka)) {
                echo "<div class='meniu'>" . $ico . " <a href='komanda.php?id=nario_cp&ka=$ka'>Nario CP</a></div>
";
            }
            if (apsas($user['team']) == apsas($ka)) {
                echo "<div class='meniu'>" . $ico . " <a href='komanda.php?id=kmisijos&ka=$ka'>Komandos Misijos</a></div>
";
            }
            if (apsas($user['team']) == apsas($ka)) {
                echo "<div class='meniu'>" . $ico . " <a href='komanda.php?id=shop&ka=$ka'><font color='red'><b>Komandos Parduotuvė<b></font></a></div>
";
            }
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='$ka'")) == false) {
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            if ($row['dienosmedaltime'] - time() < 0) {
                echo '<div class="meniuc"><b><small><font color="red">Ši komanda šio prizo nebeturi!</small></font></b></div>';
            }
            if ($row['dienosmedaltime'] - time() > 0) {
                echo '<div class="meniuc"><b>Prizas dar galios</b>:';
                if ($row['dienosmedaltime'] - time() > 0) {
                    echo '<b>' . laikas($row['dienosmedaltime'] - time(), 1) . '</b>';
                }
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='$ka'")) == false) {
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            if ($row['dienosmedaltime2'] - time() > 0) {
                echo '<div class="meniuc"><b>Prizas dar galios</b>:';
                if ($row['dienosmedaltime2'] - time() > 0) {
                    echo '<b>' . laikas($row['dienosmedaltime2'] - time(), 1) . '</b>';
                }
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='$ka'")) == false) {
        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            if ($row['dienosmedaltime3'] - time() > 0) {
                echo '<div class="meniuc"><b>Prizas dar galios</b>:';
                if ($row['dienosmedaltime3'] - time() > 0) {
                    echo '<b>' . laikas($row['dienosmedaltime3'] - time(), 1) . '</b>';
                }
...
if ($id == 'pultiteam') {
    ...
    if ($user['team'] !== $ka) {
        echo "<div class='meniuc'>Tu nesi šitoje komandoje</div>";
    } elseif ($info['vadas'] !== $nick) {
        echo "<div class='meniuc'>Tu neesi šios komandos vadas</div>";
...
if ($id == "team_boss") {
    ...
    while ($row = mysqli_fetch_assoc($query)) {
        if ($row['kovm1'] - time() < 0) {
            echo '<div class="meniuc"><b><font color="red">Norint kirsti komandų bosus, pirma turi jūsų komanda atsirakinti</b></font>!</div>';
        }
    }
    echo '<div class="meniu">';
 ...
 <b>' . $boss['name'] . '</b> smūgis: Nuo<b> ' . $boss['min_hit'] . ' ' . $att1 . '</b> iki <b>' . $boss['max_hit'] . ' ' . $att1 . '</b><br/>
        ...
        <div class="meniuc">';
        if (apsas($user['team']) == apsas($ka)) {
            echo '   ' . $ico . '  <a href="?id=attack&KD=' . $KD . '&go=' . $go . '&ka=' . $ka . '">Trenkti <b>' . $boss['name'] . '</b></a></div>';
        }
...
<font color="green"><b>' . skaicius($smugiss) . '</b>';
            if ($apie['critical'] != '0') {
                ...
                echo '
</font>' . $att1 . ' + <font color="red"><b>' . skaicius($crit) . '</b></font> ' . $att2 . '';
            }
            if ($apie['kyborgas'] != '') {
                echo ' <font color="green">*' . $kyborg . '</font> ';
                echo '' . $lygu . ' <font color="blue">  <b>' . skaicius($smugis) . '</font> ' . $att1 . '</b>';
            }
            echo '  <br/>
...
if ($id == 'misijoseuru3') {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $info['pavadinimas'] . "'")) == false) {
        echo "<div class='meniuc'>Tokios komandos nėra</div>";
    } elseif ($info['vadas'] !== $nick) {
        echo "<div class='meniuc'>Tu neesi šios komandos vadas</div>";
    }
...
<div class="meniu">';
            if ($row['kritm1'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit1&ka=$ka'>Turėti <b>10,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm1'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit1&ka=$ka'>Turėti <b>10,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm2'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit2&ka=$ka'>Turėti <b>50,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm2'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit2&ka=$ka'>Turėti <b>50,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm3'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit3&ka=$ka'>Turėti <b>100,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm3'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit3&ka=$ka'>Turėti <b>100,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm4'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit4&ka=$ka'>Turėti <b>200,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm4'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit4&ka=$ka'>Turėti <b>200,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm5'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit5&ka=$ka'>Turėti <b>400,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm5'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit5&ka=$ka'>Turėti <b>400,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm6'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit6&ka=$ka'>Turėti <b>800,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm6'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit6&ka=$ka'>Turėti <b>800,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm7'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit7&ka=$ka'>Turėti <b>1,200,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm7'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit7&ka=$ka'>Turėti <b>1,200,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm8'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit8&ka=$ka'>Turėti <b>1,600,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm8'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit8&ka=$ka'>Turėti <b>1,600,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm9'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit9&ka=$ka'>Turėti <b>2,000,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm9'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit9&ka=$ka'>Turėti <b>2,000,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kritm10'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit10&ka=$ka'>Turėti <b>3,000,000 </b> Kritinio Lygio</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kritm10'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskrit10&ka=$ka'>Turėti <b>3,000,000</b> Kritinio Lygio</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
        }
        echo "	</div>";
    }
...
<div class="meniu">';
            if ($row['eurm1'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru1&ka=$ka'>Sutaupyti <b>100 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm1'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru1&ka=$ka'>Sutaupyti <b>100</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm2'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru2&ka=$ka'>Sutaupyti <b>250 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm2'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru2&ka=$ka'>Sutaupyti <b>250</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm3'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru3&ka=$ka'>Sutaupyti <b>500 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm3'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru3&ka=$ka'>Sutaupyti <b>500</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm4'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru4&ka=$ka'>Sutaupyti <b>1,000 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm4'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru4&ka=$ka'>Sutaupyti <b>1,000</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm5'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru5&ka=$ka'>Sutaupyti <b>2,000 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm5'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru5&ka=$ka'>Sutaupyti <b>2,000</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm6'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru6&ka=$ka'>Sutaupyti <b>4,000 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm6'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru6&ka=$ka'>Sutaupyti <b>4,000</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm7'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru7&ka=$ka'>Sutaupyti <b>7,000 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm7'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru7&ka=$ka'>Sutaupyti <b>7,000</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm8'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru8&ka=$ka'>Sutaupyti <b>12,000 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm8'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru8&ka=$ka'>Sutaupyti <b>12,000</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm9'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru9&ka=$ka'>Sutaupyti <b>20,000 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm9'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru9&ka=$ka'>Sutaupyti <b>20,000</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['eurm10'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru10&ka=$ka'>Sutaupyti <b>30,000 </b>$eurui</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['eurm10'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoseuru10&ka=$ka'>Sutaupyti <b>30,000</b>$eurui</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
...
<div class="meniu">';
            if ($row['pinm1'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu1&ka=$ka'>Sutaupyti <b>" . skaicius(1000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm1'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu1&ka=$ka'>Sutaupyti <b>" . skaicius(1000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm2'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu2&ka=$ka'>Sutaupyti <b>" . skaicius(5000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm2'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu2&ka=$ka'>Sutaupyti <b>" . skaicius(5000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm3'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu3&ka=$ka'>Sutaupyti <b>" . skaicius(20000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm3'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu3&ka=$ka'>Sutaupyti <b>" . skaicius(20000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm4'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu4&ka=$ka'>Sutaupyti <b>" . skaicius(50000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm4'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu4&ka=$ka'>Sutaupyti <b>" . skaicius(50000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm5'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu5&ka=$ka'>Sutaupyti <b>" . skaicius(150000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm5'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu5&ka=$ka'>Sutaupyti <b>" . skaicius(150000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm6'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu6&ka=$ka'>Sutaupyti <b>" . skaicius(500000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm6'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu6&ka=$ka'>Sutaupyti <b>" . skaicius(500000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm7'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu7&ka=$ka'>Sutaupyti <b>" . skaicius(1500000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm7'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu7&ka=$ka'>Sutaupyti <b>" . skaicius(1500000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm8'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu8&ka=$ka'>Sutaupyti <b>" . skaicius(5000000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm8'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu8&ka=$ka'>Sutaupyti <b>" . skaicius(5000000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm9'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu9&ka=$ka'>Sutaupyti <b>" . skaicius(20000000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm9'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu9&ka=$ka'>Sutaupyti <b>" . skaicius(20000000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['pinm10'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu10&ka=$ka'>Sutaupyti <b>" . skaicius(50000000000000) . "</b></a>$pinigaii [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['pinm10'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijospinigu10&ka=$ka'>Sutaupyti <b>" . skaicius(50000000000000) . "</b></a>$pinigaii [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
...
<div class="meniu">';
            if ($row['kovm1'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu1&ka=$ka'>Padaryti <b>10,000 </b>kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm1'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu1&ka=$ka'>Padaryti <b>10,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm2'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu2&ka=$ka'>Padaryti <b>50,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm2'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu2&ka=$ka'>Padaryti <b>50,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm3'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu3&ka=$ka'>Padaryti <b>100,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm3'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu3&ka=$ka'>Padaryti <b>100,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm4'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu4&ka=$ka'>Padaryti <b>200,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm4'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu4&ka=$ka'>Padaryti <b>200,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm5'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu5&ka=$ka'>Padaryti <b>400,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm5'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu5&ka=$ka'>Padaryti <b>400,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm6'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu6&ka=$ka'>Padaryti <b>800,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm6'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu6&ka=$ka'>Padaryti <b>800,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm7'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu7&ka=$ka'>Padaryti <b>1,500,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm7'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu7&ka=$ka'>Padaryti <b>1,500,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm8'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu8&ka=$ka'>Padaryti <b>3,000,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm8'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu8&ka=$ka'>Padaryti <b>3,000,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm9'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu9&ka=$ka'>Padaryti <b>5,000,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm9'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu9&ka=$ka'>Padaryti <b>5,000,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
            if ($row['kovm10'] - time() > 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu10&ka=$ka'>Padaryti <b>8,000,000</b> kovų</a> [<b><font color='green'>Įvygdyta</b></font>]<br>";
            }
            if ($row['kovm10'] - time() < 0) {
                echo "		" . $ico . " <a href='komanda.php?id=misijoskovu10&ka=$ka'>Padaryti <b>8,000,000</b> kovų</a> [<b><font color='red'>Neįvygdyta</b></font>]<br>";
            }
...
if ($id == 'pervedu_pinigus') {
    ...
    if ($user['team'] !== $ka) {
        ...
        echo "<div class='meniuc'>Neįrašei kiek pervesi</div>";
    } elseif ($apie['litai'] < $kiek) {
        echo "<div class='meniuc'>Neturi tiek pinigų</div>";
    } else {
...
if ($id == 'pervedu_eurus') {
    ...
    if ($user['team'] !== $ka) {
        ...
        echo "<div class='meniuc'>Neįrašei kiek pervesi</div>";
    } elseif ($apie['sms_litai'] < $kiek) {
        echo "<div class='meniuc'>Neturi tiek eurų</div>";
    } else {
        echo "<div class='meniuc'><b>Atlikta</b></div>";
...
if ($id == 'keiciu_topic') {
    ...
    if ($user['team'] !== $ka) {
        ...
        echo "<div class='meniuc'>Neįrašei topic</div>";
    } else {
        echo "<div class='meniuc'><b>Atlikta</b></div>";
...
if ($id == 'pv_cp') {
    ...
    if ($info['pavadotuojas'] !== $nick) {
        echo "<div class='meniuc'>Tu neesi šios komandos pavaduotojas</div>";
    } elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $info['pavadinimas'] . "'")) == false) {
        echo "<div class='meniuc'Tokios komandos nėra</div>";
    } else {
        echo "<div class='meniu'>
...
if ($id == 'veduospin') {
    ...
    top('Pinigų pervedimas');
    if ($info['vadas'] !== $nick) {
        echo "Tu nesi šios komandos vadas";
    } elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $info['pavadinimas'] . "'")) == false) {
        echo "Tokios komandos nėra";
    } else {
...
if ($id == 'persivedu_pinigus') {
    ...
    if ($info['vadas'] !== $nick) {
        ...
        echo "<div class='meniuc'>Neįrašei kiek pervesi!</div>";
    } elseif ($info['pinigai'] < $kiek) {
        echo "<div class='meniuc'>Nėra tiek pinigų!</div>";
    } else {
...
if ($id == 'persivedu_eurus') {
    ...
    if ($info['vadas'] !== $nick) {
        ...
        echo "<div class='meniuc'>Neįrašei kiek pervesi!</div>";
    } elseif ($info['eurai'] < $kiek) {
        echo "<div class='meniuc'>Nėra tiek eurų!</div>";
    } else {
...
if ($id == 'keiciu_alga') {
    ...
    elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $info['pavadinimas'] . "'")) == false) {
        ...
        echo "<div class='meniuc'>Neįrašei algos $pinigaii !</div>";
    } else {
...
if ($id == 'keiciu_alga2') {
    ...
    elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $info['pavadinimas'] . "'")) == false) {
        ...
        echo "<div class='meniuc'>Neįrašei algos $eurui !</div>";
    } else {
        echo "<div class='meniuc'><b>Atlikta, alga pakeista!</b></div>";
...
if ($id == 'metu') {
    ...
    } elseif ($info2['team'] !== $ka) {
        echo "<div class='meniuc'>Šis žaidėjas ne tavo komandoje</div>";
    } elseif ($kas == $nick) {
        echo "<div class='meniuc'>Savęs išmesti negalite</div>";
    } else {
...
if ($id == 'kvieciu') {
    ...
    elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $info['pavadinimas'] . "'")) == false) {
        ...
        echo "<div class='meniuc'>Tokio vartotojo nėra</div>";
    } elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM kvietimai_i_komanda WHERE nick2='$kas'")) == TRUE) {
        echo "<div class='meniuc'>Šiam žaidėjui jau išsiųstas pakvietimas</div>";
    } elseif ($kas == $nick) {
        echo "<div clas='meniuc'>Savęs kviesti negalima</div>";
    } elseif (!empty($info2['team'])) {
        echo "<div class='meniuc'><b>$kas</b> žaidėjas jau yra komandoje</div>";
    } elseif (empty($kas)) {
        echo "<div class='meniuc'>Neįrašei ką kvieti</div>";
...
if ($id == 'priimti') {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM kvietimai_i_komanda WHERE nick2='$nick'")) == false) {
        echo "<div class='meniuc'>Tavęs nieks nekviečia į komandą</div>";
    } elseif ($ka != $infa['team']) {
        echo "<div class='meniuc'>Tavęs ši komanda nekviečia</div>";
    } elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $infa['team'] . "'")) == false) {
        echo "<div class='meniuc'>Tokios komandos nėra</div>";
...
if ($id == 'atmesti') {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM kvietimai_i_komanda WHERE nick2='$nick'")) == FALSE) {
        echo "<div class='meniuc'>Tavęs nieks nekviečia į komandą</div>";
    } elseif (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM team WHERE pavadinimas='" . $info['team'] . "'")) == false) {
        echo "<div class='meniuc'>Tokios komandos nėra</div>";
    } elseif (!empty($user['team'])) {
        echo "<div class='meniuc'>Tu jau esi komandoje</div>";
    } else {
