...
baneris();
topbar();
$kasimas = mysql_fetch_assoc(mysql_query("SELECT * FROM kasyklav WHERE id='$VS' "));
...
echo'</div>';
    ...
    $query = mysql_query("SELECT * FROM kasykla3");
   while($row = mysql_fetch_assoc($query)){
...
$ID = sk($_GET['ID']);
   online('Kasykloje');
   $lok = mysql_fetch_assoc(mysql_query("SELECT * FROM kasykla WHERE id='$ID' "));
echo'<div class="meniuc"><img src="img/kasimas/kasykla.png" border="1"></div>
...
echo'<div class="meniuc"><a href="?id=rudos"><font color="red"><b>Iškasti ištekliai</b></font></a></div>';
    if(mysql_num_rows(mysql_query("SELECT * FROM kasykla WHERE id='$ID' ")) == 0){
          echo '<div class="up"><b>Klaida!</b></div>';
          echo '<div class="meniuc">Tokios vietos nėra!</div>';
    } else {
         $total = mysql_result(mysql_query("SELECT COUNT(*) FROM kasyklav WHERE lokacija='$ID'"),0);
...
echo '<div class="up">'.$ico.'Jūsų (<b>'.$apie['kasimolvl'].'   LVL</b> kasimo)</div>';
             echo '';
             $query = mysql_query("SELECT * FROM kasyklav WHERE lokacija='$ID' ");
             while($row = mysql_fetch_assoc($query)){
...
if($id == 'kasu'){
    ...
    if ($apie['last_fight_time'] > $time) {
        ...
        mysql_query("INSERT INTO block SET nick='$nick', uz='$message', time='$b_laikas2', kas_ban='$kasBan'");
...
$kasimoreward=0;}
   $lok = mysql_fetch_assoc(mysql_query("SELECT * FROM kasykla WHERE id='$ID' "));
   $mob = mysql_fetch_assoc(mysql_query("SELECT * FROM kasyklav WHERE id='$VS' "));
   $m = mysql_fetch_array(mysql_query("SELECT * FROM zaidejai WHERE nick='$nick'"));
    ...
    if(mysql_num_rows(mysql_query("SELECT * FROM kasyklav WHERE id='$VS' ")) == 0){
          echo '<div class="up">Klaida !</div>';
...
echo'<div class="meniuc"><img src="img/kasimas/kasykla.png" border="1"></div>';
 ...
 $g_n[] = array("pagrindinis.php?id=","Pagrindinis","kasimas.php", "Rūdos kasimas", "Klaida");
    ...
    mysql_query("UPDATE zaidejai SET kda2='$KDS' WHERE nick='$nick'");
             ...
             $query = mysql_query("SELECT * FROM kasyklav WHERE lokacija='$ID' ORDER BY id='$VS' DESC LIMIT 1");
             while($row = mysql_fetch_assoc($query)){
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'70' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET kadmiok=kadmiok+'1', varis=varis-'1000' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'100' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET cirkoniok=cirkoniok+'1', kadmis=kadmis-'1200' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'120' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET geleziesk=geleziesk+'1', cirkonis=cirkonis-'2000' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'150' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET sidabrok=sidabrok+'1', gelezis=gelezis-'2500' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'200' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET auksok=auksok+'1', sidabras=sidabras-'3000' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'250' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET platinosk=platinosk+'1', auksas=auksas-'3500' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'300' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET titanok=titanok+'1', platina=platina-'5000' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'350' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET osmiok=osmiok+'1', titanas=titanas-'8000' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'400' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET manganok=manganok+'1', osmis=osmis-'1200' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'12000' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET unikalusk=unikalusk+'1', manganas=manganas-'100000' WHERE nick='$nick' ");
...
mysql_query("UPDATE zaidejai SET sms_litai=sms_litai-'50000' WHERE nick='$nick' ");
	mysql_query("UPDATE inv SET unikalusk2=unikalusk2+'1', kvarcas=kvarcas-'1000000' WHERE nick='$nick' ");
...
if($id =='keiciumangana1'){
    ...
    if(isset($_POST['submit'])){
        ...
        elseif($gynybaa < 300){
            ...
            mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
            mysql_query("UPDATE inv SET manganas=manganas-'$kainn' WHERE nick='$nick' ");
        }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET gelezis=gelezis-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET sidabras=sidabras-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET auksas=auksas-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET platina=platina-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET titanas=titanas-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET osmis=osmis-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET anglis=anglis-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET mineralai=mineralai-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET spatas=spatas-'$kainn' WHERE nick='$nick' ");
			  }
...
top('Iškasenų keitimas');
        ...
        if(isset($_POST['submit'])){
	        ...
	        mysql_query("UPDATE zaidejai SET vipticket=vipticket+'$kiekis' WHERE nick='$nick' ");
			mysql_query("UPDATE inv SET kvarcas=kvarcas-'$kainn' WHERE nick='$nick' ");
			  }
