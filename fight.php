...
/// bandau
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "Kovų laukas"];
    navigacija($g_n);
} elseif ($id == "vieta") {
    if ($nust['kovos'] == "-") {
        top('Kovų laukas');
...
<div class="meniuc">';
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "fight.php?id=", "Kovų laukas", "Vietovė"];
    navigacija($g_n);
}
...
Kiek EXP:<br /><input type="text" name="exp"/><br />
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "fight.php", "Kovų zona", "Keitimas"];
    navigacija($g_n);
} // reward
...
<div class="meniuc">
  Pasiek <b>' . skaicius(500000) . ' </b>veiksmų ir <b>75</b> lygį <small>ir tada galėsi įvygdyti šią kovų reward misiją!</small><br>Įvygdžius gausi <b>Kovų Rewardą</b>!<br>Su kuriuo kovų zonoje sumažinsi visų mobų ' . $kgi . ' <b>2</b> kartus!
   ...
   <a href="?id=kovureward2">Pasiekiau reikiama kiekį!</a>
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "fight.php", "Kovų zona", "Kovų reward misija"];
    navigacija($g_n);
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "fight.php", "Kovų zona", "Kovų reward"];
    navigacija($g_n);
...
/// reward
        ...
        } elseif (mysqli_num_rows(mysqli_query($conn,"SELECT * FROM mobai WHERE id='$VS' ")) == 0) {
            echo '<div class="up">Klaida !</div>';
...
<img src="img/imgg/zona.png" /></div>';
        ...
        } elseif ($gyvybes == 4444444 || $mob['kg'] / $kovureward > $kg) {
            top(\KLAIDA);
            ...
            if ($nust['dtop_nick'] !== $nick) {
                if (mysqli_num_rows(mysqli_query($conn,"SELECT * FROM dtop WHERE nick='$nick'")) > 0) {
                    mysqli_query($conn,"UPDATE dtop SET vksm=vksm+1 WHERE nick='$nick'");
                } else {
                    mysqli_query($conn,"INSERT INTO dtop SET vksm='1', nick='$nick'");
                }
                if (mysqli_num_rows(mysqli_query($conn,"SELECT * FROM s_top WHERE nick='$nick'")) > 0) {
                    mysqli_query($conn,"UPDATE s_top SET vksm=vksm+1 WHERE nick='$nick'");
                } else {
                    mysqli_query($conn,"INSERT INTO s_top SET vksm='1', nick='$nick'");
                }
            }
...
(<b>' . skaicius($mob['kg'] / $kovureward) . '</b> <img src="img/bicons/kovines.png" />)</div>  ';
            ...
            if ($divineProsperityBuff instanceof \LegacyDbz\Players\DTO\PlayerSkill) {
                echo '<br>';
            ...
            if ($exist) {
                ...
                mysqli_query($conn,"INSERT INTO pm SET gavejas='testas1', what='SISTEMA', txt='$adminMessage', time='" . time() . "', nauj='NEW'") || die(mysqli_error());
...
Esate išjungęs <b>Kovų Paveiksliukus</b>!</div>';
  ...
  <img src="img/veikejaic/' . $mob['img'] . '.png" alt="IMG" height="120" width="120">
            ...
            if ($dtop2['vksm'] == 40000) {
                ...
                mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai+'35' WHERE nick='$apie[nick]'") || die(mysqli_error());
            ...
            if ($dtop2['vksm'] == 25000) {
                ...
                mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai+'30' WHERE nick='$apie[nick]'") || die(mysqli_error());
            ...
            if ($dtop2['vksm'] == 15000) {
                ...
                mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai+'25' WHERE nick='$apie[nick]'") || die(mysqli_error());
            ...
            if ($dtop2['vksm'] == 7000) {
                ...
                mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai+'20' WHERE nick='$apie[nick]'") || die(mysqli_error());
            ...
            if ($dtop2['vksm'] == 3500) {
                ...
                mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai+'15' WHERE nick='$apie[nick]'") || die(mysqli_error());
            ...
            if ($dtop2['vksm'] == 1500) {
                ...
                mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai+'10' WHERE nick='$apie[nick]'") || die(mysqli_error());
            ...
            if ($dtop2['vksm'] == 500) {
                ...
                mysqli_query($conn,"UPDATE zaidejai SET sms_litai=sms_litai+'5' WHERE nick='$apie[nick]'") || die(mysqli_error());
...
<div class="meniuc">';
            ...
            if ($moneyBuff instanceof \LegacyDbz\Players\DTO\PlayerSkill) {
...
Padaręs išviso  <img src="img/bicons/attack1.png" /> <b> ' . sk($apie['veiksmai']) . '</b></div>';
            ...
            echo '<div class="up">
' . $ico . ' Dropas:<br></div>';
            if ($inv['radaras'] == '1' && random_int(1, 400) == 200) {
...
<div class="meniuc">
 <img src="img/bicons/green.png" />     <b>Gavai ' . $kiek_duos . '   <font color="green"><b>Išbarstytą rutulį</b></font>! </b><br/></div>';
            ...
            if ((int)$apie['jirenmb'] - time() > 0 && random_int(1, 600) == 201) {
                if ((int)$apie['duxdaig'] - time() > 0) {
...
<div class="meniuc">
 <img src="img/bicons/green.png" />     <b>Gavai ' . $kiek_duos . '   <font color="red">Super Amulet Iteam</font>! </b><br/></div>';
            ...
            if ((int)$apie['bts'] - time() > 0 && random_int(1, 400) == 222) {
                $kiek_bt = (int)$apie['bt'] - time() > 0 ? $kiek_bt + 2 : 1;
                echo ' 
<div class="meniuc">
...
<div class="meniuc">
 <img src="img/bicons/green.png" />     <b>Gavai ' . $kiek_duos . ' <font color="red"><b>  Kario tobuljimas! </b><br/></div></font>';
	...
	';
            ...
            if (!empty($fusn['kitas_zaidejas']) && $fusn['double_fussion_dance'] == '+') {
                $mob['exp'] /= 10;
                mysqli_query($conn,"UPDATE zaidejai SET exp=exp+'$mob[exp]' WHERE nick='$fusn[kitas_zaidejas]'") || die(mysqli_error());
                mysqli_query($conn,"UPDATE susijungimas SET uzdirbo_exp=uzdirbo_exp+'$mob[exp]' WHERE nick='$nick'") || die(mysqli_error());
            }
            ...
            if (!empty($user['team'])) {
                ...
                mysqli_query($conn,"UPDATE team SET viso_laimejo_kovu='$pius', pinigai='$pius2', eurai='$pius3' WHERE pavadinimas = '" . $user['team'] . "'") || die(mysqli_error());
                mysqli_query($conn,"UPDATE user SET win_in_team='$plius',iki_algos=iki_algos-'1' WHERE nick='$nick'") || die(mysqli_error());
                if (!mysqli_num_rows(mysqli_query($conn,"SELECT * FROM komandu_dtop WHERE team = '$user[team]'"))) {
                    mysqli_query($conn,"INSERT INTO komandu_dtop SET laimejo_kovu='0', team = '" . $user['team'] . "'") || die(mysqli_error());

                } else {
                    mysqli_query($conn,"UPDATE komandu_sav_dtop SET laimejo_kovu=laimejo_kovu+1 WHERE team='" . $user['team'] . "'") || die(mysqli_error());
                    mysqli_query($conn,"UPDATE komandu_dtop SET laimejo_kovu=laimejo_kovu+1 WHERE team='" . $user['team'] . "'") || die(mysqli_error());
            ...
            if (!mysqli_num_rows(mysqli_query($conn,"SELECT * FROM komandu_sav_dtop WHERE team = '$user[team]'"))) {
                mysqli_query($conn,"INSERT INTO komandu_sav_dtop SET laimejo_kovu='0', team = '" . $user['team'] . "'") || die(mysqli_error());
            ...
            if ($usex['kovu_trn'] == '+' && ($nst['trn_busena'] == '2' || $nst['trn_busena'] == '3' || $nst['trn_busena'] == '4' || $nst['trn_busena'] == '5')) {
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "fight.php?id=", "Kovos", "Kovojimas"];
    navigacija($g_n);
   ...
   ' . $ico2 . ' Gavai <b>' . sk($xp) . '</b> EXP.<br/>
	...
	';
        ...
        if (!empty($user['team'])) {
            ...
            mysqli_query($conn,"UPDATE team SET viso_laimejo_kovu='$pius' WHERE pavadinimas = '" . $user['team'] . "'") || die(mysqli_error());
            mysqli_query($conn,"UPDATE user SET win_in_team='$plius',iki_algos=iki_algos-'1' WHERE nick='$nick'") || die(mysqli_error());
            if (!mysqli_num_rows(mysqli_query($conn,"SELECT * FROM komandu_dtop WHERE team = '$user[team]'"))) {
                mysqli_query($conn,"INSERT INTO komandu_dtop SET laimejo_kovu='0', team = '" . $user['team'] . "'") || die(mysqli_error());
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "fight.php?id=", "Kovos", "Kovų mašina"];
    navigacija($g_n);
...
if ($id == "bonusai") {
    ...
    $g_n[] = ["pagrindinis.php?id=", "Pagrindinis", "fight.php?id=", "Kovos", "Bonusai"];
    navigacija($g_n);
}
...
function getItemsAmount()
{
    ...
    $activeLuckyDropBuff = $playerActiveBuffs->first(fn(PlayerSkill $playerSkill) => $playerSkill->skill()->name() === Skill::BUFF_NAME_LUCKY_DROP);
