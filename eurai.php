...
' . $ico . ' <a href="eurai.php?id=dgxp">Daugiau 
 <img src="img/bicons/pinigai.png" /> ,  <img src="img/bicons/exp.png" /> </a>';
        if ((int)$apie['duxpx'] - time() > 0) {
            echo '
(<font color="green"><b>' . laikas((int)$apie["duxpx"] - time(), 1) . '</b></font>)<br>';
        }
    }
    if ((int)$apie['duxpx'] - time() < 0) {
        echo '
...
neturi pakankamai <b><font color="red">angelo sparnų!</b></font></div>';
    ...
    } elseif ((int)$apie['cukatailb'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
120000 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['gokasultrab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
150000 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['gokasultramb'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
200000 <font color="red"><b>Naikinimo galios!</b></font>
    ...
    } elseif ((int)$apie['toppomb'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
250000 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['jirenmb'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
500000 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['gohanultrab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
1,000,000 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['vegetaultrab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
3,000,000 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['vegitoultrab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
145000 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['gokas20xb'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
15000  <font color="red"><b>Naikinimo galios!</b></font>
    ...
    } elseif ((int)$apie['quitelab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
10000  <font color="red"><b>Angelo sparnų!</b></font>
    ...
    } elseif ((int)$apie['vadoseb'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
...
5000  <font color="red"><b>Naikinimo galios!</b></font>
    ...
    } elseif ((int)$apie['champab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
    ...
    } elseif ((int)$apie['goldozarub'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
    ...
    } elseif ((int)$apie['maxfryzasb'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
    $g_n[] = array("pagrindinis.php?id=", "Pagrindinis", "eurai.php", "Eurai", "eurai.php?id=uni", "Unikalus veikejai", "Veikejo pirkimas");
    navigacija($g_n);
...
12500 <font color="red"><b>Kario tobulėjimo!</b></font>
    ...
    } elseif ((int)$apie['magetab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
    ...
    } elseif ((int)$apie['vegetab'] - time() > 0) {
        echo '<div class="meniuc">Tu jau pirkai šį veikėją!</div>';
    }
    $g_n[] = array("pagrindinis.php?id=", "Pagrindinis", "eurai.php", "Eurai", "eurai.php?id=uni", "Unikalus veikejai", "Veikejo pirkimas");
    navigacija($g_n);
...
<img src="img/bicons/euro.png" />
    ...
    } elseif ((int)$apie['pliusaib'] - time() > 0) {
        echo '<div class="meniuc">Tu jau turi šią paslaugą!</div>';
    }
...
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['dgeur'] - time(), 1) . '</b></div>';
    }
...
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['dglg'] - time(), 1) . '</b></div>';
    }
...
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['duxkrd'] - time(), 1) . '</b></div>';
    }
...
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['duxaux'] - time(), 1) . '</b></div>';
    }
...
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['dgax'] - time(), 1) . '</b></div>';
    }
...
elseif ($id == "daiktai2") {
    ...
    if ((int)$apie['duxdaig'] - time() < 0) {
        if (isset($_POST['submit'])) {
            ...
            if (empty($kiekv)) {
                echo '<div class="meniuc">Palikai tuščią laukelį!</div>';
            } elseif ((int)$apie['duxdaig'] - time() > 0) {
                echo '<div class="meniuc">Tu jau turi šią paslaugą!</div>';
            } elseif ($kainn > $apie['sms_litai']) {
                echo '<div class="meniuc">Neturi pakankamai 
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['duxdaig'] - time(), 1) . '</b></div>';
    }
...
elseif ($id == "rudos2") {
    ...
    if ((int)$apie['kasimas2x'] - time() < 0) {
        if (isset($_POST['submit'])) {
            ...
            if (empty($kiekv)) {
                echo '<div class="meniuc">Palikai tuščią laukelį!</div>';
            } elseif ((int)$apie['kasimas2x'] - time() > 0) {
                echo '<div class="meniuc">Tu jau turi šią paslaugą!</div>';
            } elseif ($kainn > $apie['sms_litai']) {
                echo '<div class="meniuc">Neturi pakankamai 
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['kasimas2x'] - time(), 1) . '</b></div>';
    }
    ...
    if ((int)$apie['kasimolvl2x'] - time() < 0) {
        if (isset($_POST['submit'])) {
            ...
            if (empty($kiekv)) {
                echo '<div class="meniuc">Palikai tuščią laukelį!</div>';
            } elseif ((int)$apie['kasimolvl2x'] - time() > 0) {
                echo '<div class="meniuc">Tu jau turi šią paslaugą!</div>';
            } elseif ($kainn > $apie['sms_litai']) {
                echo '<div class="meniuc">Neturi pakankamai 
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['kasimolvl2x'] - time(), 1) . '</b></div>';
    }
...
<img src="img/bicons/euro.png" />
        ...
        echo '<div class="meniuc">Paslauga tau dar galios: <b>' . laikas((int)$apie['duxpx'] - time(), 1) . '</b></div>';
    }
...
elseif ($id == "krd") {
    ...
    echo '<div class="meniuc">1 <img src="img/bicons/euro.png" />   - 5   <img src="img/bicons/credit.png" />  </div>';
    echo '<div class="meniuc">
...
if ($id == 'veikejaejeji') {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM veikejai WHERE id='$ka'")) == 0) {
        ...
        if (!empty($veik['sugebejimas'])) {
            echo '      ' . $ico2 . ' Sugebėjimas: ' . $veik['sugebejimas'] . '<br/>';
        }
