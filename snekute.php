...
if(preg_match("#isvalyk#", $zin) && apsas($statusas) == apsas('Admin')){
		mysqli_query($conn,"DELETE FROM pokalbiai");
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Išvaliau zujkuti:* ', data='".time()."'");
			
			
		}
	elseif(preg_match("#isvalyk#", $zin) && apsas($nick) == apsas('sajanas')){
		mysqli_query($conn,"DELETE FROM pokalbiai");
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Išvaliau mažuti:* ', data='".time()."'");
...
mysqli_query($conn,"INSERT INTO pm SET what='Snekute', txt='$zinute', gavejas='$onn[1]', time='".time()."', nauj='NEW' ") or die(mysqli_error());

mysqli_query($conn,"UPDATE zaidejai SET litai=litai+'100000000', sms_litai=sms_litai+'100', auksiniai=auksiniai+'5000', kred=kred+'200', vipticket=vipticket+'2000' WHERE nick='$onn[1]'");	
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Padariau dalybas! Pisu protą, nieką nepadariau :xi ', data='".time()."'");
...
elseif(preg_match("#on sistem#", $zin) && apsas($nick) == apsas('sajanas')){
		mysqli_query($conn,"UPDATE nustatymai SET snekute='+'");
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Kaip liepsi, CORE ', data='".time()."'");
...
if($nust['snekute'] == "+"){
		...
		if(preg_match("#sveiki#", $zin)){
		  ...
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='$nick sveikas:*', data='".time()."'");
...
if(preg_match("#kas yra duchas?#", $zin)){
		  ...
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='$nick yra duchas:p', data='".time()."'");
		...
		if(preg_match("#kas geriausias#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='CORE geriausias :P', data='".time()."'");
			
			
		}
			if(preg_match("#dirbam#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Eik tu melagi, nieko tu nedirbi :P', data='".time()."'");
			
			
		}
				if(preg_match("#ka jus#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='spardom tave xD', data='".time()."'");
			
			
		}

				if(preg_match("#tulpe#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Tavo tėvas, bybį čiulpė:p', data='".time()."'");
...
$ti = time()+90000;
	    mysqli_query($conn,"INSERT INTO block1 SET nick = '$nick', uz='Reklama!', kas_ban='Snekute', time='$ti'");
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Prisižaidei!', data='".time()."'");
mysqli_query($conn,"UPDATE user SET gavomute=gavomute+'1' WHERE nick = '$nick'") or die(mysqli_error());
		}
...
$ti = time()+900;
	    mysqli_query($conn,"INSERT INTO block1 SET nick = '$nick', uz='Nesikeik daugiau!', kas_ban='Snekute', time='$ti'");
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Prisižaidei!', data='".time()."'");
mysqli_query($conn,"UPDATE user SET gavomute=gavomute+'1' WHERE nick = '$nick'") or die(mysqli_error());
		}
...
/// end
		  ...
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Ne tavo reikalas:\', data='".time()."'");
		  ...
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Žaidimo savininkas yra CORE.', data='".time()."'");
		  ...
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Tai pisk miegot, ko lauki?.', data='".time()."'");
			
			
		}

				if(preg_match("#prašau duok#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Tuoj aš tau kaip duosiu:*', data='".time()."'");
			
			
		}

				if(preg_match("#kas tu esi?#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Aš esu, kurėjo sukurta sistema.', data='".time()."'");
			
			
		}

				if(preg_match("#kaip sekas?#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Viskas gerai,o tau kaip?', data='".time()."'");
		  ...
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Gyvenimas - dūros stumimas.', data='".time()."'");
			
			
		}
if(preg_match("#mykg#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Tavo kg yra <b>".skaicius($kg)."</b> kg', data='".time()."'");
			
			
		}

					if(preg_match("#prasau#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Prašyk toliau :D ', data='".time()."'");
			
			
		}
						
			if(preg_match("#labanakt#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='$nick, Čiau zujki :xi', data='".time()."'");
			
			
		}
				if(preg_match("#einam#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='kur einam, tuoj aš tau bybį nurausiu :D', data='".time()."'");
			
			
		}
					if(preg_match("#ar Mantas kietas#", $zin)){
		  mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='Mantas ? :DDD banano kietumo', data='".time()."'");
...
$as = $input[$rand_keys[0]];
		...
		mysqli_query($conn,"INSERT INTO pokalbiai SET nick='Snekute', sms='".$nick." -> ".$as."', data='".time()."'");
		}
