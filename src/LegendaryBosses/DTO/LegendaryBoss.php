...
namespace LegacyDbz\LegendaryBosses\DTO;
...
class LegendaryBoss
{
    ...
    public function isRevivalDamageType()
    {
        return $this->damageType === self::DAMAGE_TYPE_REVIVAL;
    }

    public function isDeathDamageType()
    {
        return $this->damageType === self::DAMAGE_TYPE_DEATH;
    }
