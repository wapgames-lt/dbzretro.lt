...
if($id == ""){
    ...
    $viso = mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*) FROM isbarstyta"))[0];
    ...
    if($viso > 0){
            ...
            $query = mysqli_query($conn,"SELECT * FROM isbarstyta ORDER BY turima DESC LIMIT $nuo_kiek,$rezultatu_rodymas");
