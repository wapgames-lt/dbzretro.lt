...
// if($esamas_puslapis>1){$pusll=$esamas_puslapis-1; $puslapiavimas.="<a class=\"page\" href=\"$puslapiavimo_adresas&#38;psl=$pusll\"></a> ";}else{$puslapiavimas.=" ";}
 ...
 if($esamas_puslapis>1){$puslapiavimas.="<a class=\"page\" href=\"$puslapiavimo_adresas&#38;psl=1\">1</a> ";}else{$puslapiavimas.="<b>1</b> ";}
 if($esamas_puslapis11>1000){$puslapiavimas.="... ";}
 if($esamas_puslapis11>1 && $esamas_puslapis11<$esamas_puslapis1){$puslapiavimas.="<a class=\"page\" href=\"$puslapiavimo_adresas&#38;psl=$esamas_puslapis11\">$esamas_puslapis11</a> ";}
 if($esamas_puslapis1>1 && $esamas_puslapis>2){$puslapiavimas.="<a class=\"page\" href=\"$puslapiavimo_adresas&#38;psl=$esamas_puslapis1\">$esamas_puslapis1</a> ";}
 if($esamas_puslapis>1 && $esamas_puslapis<$puslapiu_is_viso){$puslapiavimas.="<b>$esamas_puslapis</b></span> ";}
 if($esamas_puslapis2<$puslapiu_is_viso && $esamas_puslapis<$puslapiu_is_viso1){$puslapiavimas.="<a class=\"page\" href=\"$puslapiavimo_adresas&#38;psl=$esamas_puslapis2\">$esamas_puslapis2</a> ";}
 if($esamas_puslapis22<$puslapiu_is_viso && $esamas_puslapis22>$esamas_puslapis2){$puslapiavimas.="<a class=\"page\" href=\"$puslapiavimo_adresas&#38;psl=$esamas_puslapis22\">$esamas_puslapis22</a> ";}
 if($esamas_puslapis22<$puslapiu_is_viso1){$puslapiavimas.="... ";}
 if($puslapiu_is_viso=="$esamas_puslapis"){$puslapiavimas.="<b>$puslapiu_is_viso</b></span> ";}else{$puslapiavimas.="<a class=\"page\" href=\"$puslapiavimo_adresas&#38;psl=$puslapiu_is_viso\">$puslapiu_is_viso</a> ";}
 }
