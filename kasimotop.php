...
if($id == ""){
    ...
    $viso = mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*) FROM kasimotop"))[0];
    ...
    if($viso > 0){
            ...
            $query = mysqli_query($conn,"SELECT * FROM kasimotop WHERE  nick != 'Jomajo' ORDER BY surinkta DESC LIMIT $nuo_kiek,$rezultatu_rodymas");
